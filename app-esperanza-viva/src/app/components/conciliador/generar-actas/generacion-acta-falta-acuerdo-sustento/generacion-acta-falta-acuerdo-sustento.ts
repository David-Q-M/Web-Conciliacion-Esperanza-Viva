...
@Component({
    ...
    templateUrl: './generacion-acta-falta-acuerdo-sustento.html',
    styleUrls: ['./generacion-acta-falta-acuerdo-sustento.css']
})
export class GeneracionActaFaltaAcuerdoSustento implements OnInit {
    audienciaId: any;
    ...
    descargarWord() {
        ...
        const header = `<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w='urn:schemas-microsoft-com:office:word' xmlns='http://www.w3.org/TR/REC-html40'><head><meta charset='utf-8'><title>Formato M</title><style>
        ...
        const content = `
        <div style="text-align: right; font-weight: bold;">FORMATO M</div>
        
        <div class="center bold uppercase" style="font-size: 14pt; margin-top: 10px;">
            FORMATO TIPO DE ACTA DE CONCILIACIÓN POR FALTA DE ACUERDO<br>CON SUSTENTO DE SU PROBABLE RECONVENCIÓN<br>(PERSONAS NATURALES)
        </div>
        ...
        <div style="border-bottom: 1px solid black; margin-bottom: 5px;">
             <p class="justify" style="margin: 0;">${this.datosActa.hechosInvitado || '________________________________'}</p>
        </div>

        <br>
        <div class="bold">DESCRIPCIÓN DE LA(S) CONTROVERSIA(S): (sustento de su probable reconvención).</div>
        <div style="border-bottom: 1px solid black; margin-bottom: 5px;">
            <p class="justify" style="margin: 0;">${this.datosActa.controversiaInvitado || '________________________________'}</p>
        </div>
        ...
        fileDownload.download = `Formato_M_FaltaDeAcuerdoSustento_${expNum}.doc`;
        fileDownload.click();
